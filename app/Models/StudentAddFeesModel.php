...
class StudentAddFeesModel extends Model
{
    ...
    static public  function getRecord(){
        $return = self::select('student_add_fees.*','class.name as class_name','users.name as created_name','student.name as student_name','student.last_name as student_last_name')
