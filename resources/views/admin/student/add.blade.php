              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6" >
                    ...
                    <input type="text" class="form-control" placeholder="Role Number " name="role_number" value="{{old('role_number')}}" required>
                  ...
                  <div class="form-group col-md-6" >
                    ...
                    <select id="states"  class="form-control" required name="states" onchange="populateLGAs()">
                      <option value="" selected disabled>Select State</option>
                      <option {{ (old('states.Abia') == 'Abia') ? 'selected':""}} value="Abia">Abia</option>
                      <option {{ (old('states') == 'Adamawa') ? 'selected':""}}  value="Adamawa">Adamawa</option>
                      <option {{ (old('states') == 'Akwa Ibom') ? 'selected':""}}  value="Akwa Ibom">Akwa Ibom</option>
                      <option {{ (old('states') == 'Anambra') ? 'selected':""}}  value="Anambra">Anambra</option>
                      <option {{ (old('states') == 'Bauchi') ? 'selected':""}}  value="Bauchi">Bauchi</option>
                      <option {{ (old('states') == 'Bayelsa') ? 'selected':""}}  value="Bayelsa">Bayelsa</option>
                      <option {{ (old('states') == 'Benue') ? 'selected':""}}  value="Benue">Benue</option>
                      <option {{ (old('states') == 'Borno') ? 'selected':""}}  value="Borno">Borno</option>
                      <option {{ (old('states') == 'Cross River') ? 'selected':""}}  value="Cross River">Cross River</option>
                      <option {{ (old('states') == 'Delta') ? 'selected':""}}  value="Delta">Delta</option>
                      <option {{ (old('states') == 'Ebonyi') ? 'selected':""}}  value="Ebonyi">Ebonyi</option>
                      <option {{ (old('states') == 'Edo') ? 'selected':""}}  value="Edo">Edo</option>
                      <option {{ (old('states') == 'Ekiti') ? 'selected':""}}  value="Ekiti">Ekiti</option>
                      <option {{ (old('states') == 'Enugu') ? 'selected':""}}   value="Enugu">Enugu</option>
                      <option {{ (old('states') == 'FCT') ? 'selected':""}}  value="FCT">Federal Capital Territory (FCT)</option>
                      <option {{ (old('states') == 'Gombe') ? 'selected':""}}  value="Gombe">Gombe</option>
                      <option {{ (old('states') == 'Imo') ? 'selected':""}}  value="Imo">Imo</option>
                      <option {{ (old('states') == 'Jigawa') ? 'selected':""}}  value="Jigawa">Jigawa</option>
                      <option {{ (old('states') == 'Kaduna') ? 'selected':""}}  value="Kaduna">Kaduna</option>
                      <option {{ (old('states') == 'Kano') ? 'selected':""}}  value="Kano">Kano</option>
                      <option {{ (old('states') == 'Katsina') ? 'selected':""}}  value="Katsina">Katsina</option>
                      <option {{ (old('states') == 'Kebbi') ? 'selected':""}}  value="Kebbi">Kebbi</option>
                      <option {{ (old('states') == 'Kogi') ? 'selected':""}}  value="Kogi">Kogi</option>
                      <option {{ (old('states') == 'Kwara') ? 'selected':""}}  value="Kwara">Kwara</option>
                      <option {{ (old('states') == 'Lagos') ? 'selected':""}}  value="Lagos">Lagos</option>
                      <option {{ (old('states') == 'Nasarawa') ? 'selected':""}}  value="Nasarawa">Nasarawa</option>
                      <option {{ (old('states') == 'Niger') ? 'selected':""}}  value="Niger">Niger</option>
                      <option {{ (old('states') == 'Ogun') ? 'selected':""}}  value="Ogun">Ogun</option>
                      <option {{ (old('states') == 'Ondo') ? 'selected':""}}  value="Ondo">Ondo</option>
                      <option {{ (old('states') == 'Osun') ? 'selected':""}}  value="Osun">Osun</option>
                      <option {{ (old('states') == 'Oyo') ? 'selected':""}}  value="Oyo">Oyo</option>
                      <option {{ (old('states') == 'Plateau') ? 'selected':""}}  value="Plateau">Plateau</option>
                      <option {{ (old('states') == 'Rivers') ? 'selected':""}}  value="Rivers">Rivers</option>
                      <option {{ (old('states') == 'Sokoto') ? 'selected':""}}  value="Sokoto">Sokoto</option>
                      <option {{ (old('states') == 'Taraba') ? 'selected':""}}  value="Taraba">Taraba</option>
                      <option {{ (old('states') == 'Yobe') ? 'selected':""}}  value="Yobe">Yobe</option>
                      <option {{ (old('states') == 'Zamfara') ? 'selected':""}}  value="Zamfara">Zamfara</option>
                    </select>
                 </div>

                <div class="form-group col-md-6" >
                  <label for="lgas">Select a Local Government Area:<span style="color: red;">*</span></label>
                  <select id="lgas" class="form-control" name="lgas"   required >
