    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{url('admin/course_material/course_material/add')}}" class="btn btn-primary">Add New Course Material</a>
        </div>
      </div>
    </div>
  </section>
                   ...
                   @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <a href="{{url('admin/course_material/course_material')}}" class="btn btn-primary" style="margin-top: 33px">Reset</a>
                      </div>
                    </div>
                </div>
               </form>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <td>
                       <a href="{{url('admin/course_material/course_material/edit/'.$value->id)}}" class="btn btn-primary" style="margin-bottom: 4px">Edit</a>
                       <a href="{{url('admin/course_material/course_material/delete/'.$value->id)}}" class="btn btn-danger" style="margin-bottom: 4px">Delete</a>
                     </td>
                    </tr>
                    @empty
                    <tr>
