...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 style="color: red">Subject List</h1>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">Search Subject</h4>
              </div>
                 ...
                 @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{url('admin/subject/list')}}" class="btn btn-primary" style="margin-top: 33px">Reset</a>
                    </div>
                  </div>
              </div>
            </form>
