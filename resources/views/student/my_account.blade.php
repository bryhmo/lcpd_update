              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6" >
                    ...
                    <input type="text" class="form-control" placeholder="Admission Number " name="admission_number" value="{{old('admission_number',$getRecord->admission_number)}}" readonly>
                ...
                <div class="form-group col-md-6" >
                  ...
                  <select id="lgas" class="form-control"  name="lgas" value="{{old('lgas',$getRecord->lgas )}}">
